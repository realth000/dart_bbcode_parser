  ...
  group('superscript tag', () {
    test('without content', () {
      ...
      checkSingleTag(
        ...
        expectedAST: [const SuperscriptTag(start: 0, end: head.length + content.length + tail.length)],
        expectedDelta: [
          Operation.insert(content, {SuperscriptTag.empty.quillAttrName: SuperscriptTag.empty.quillAttrValue}),
          Operation.insert('\n'),
        ],
      );
    });
