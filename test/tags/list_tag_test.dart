...
[/list]
      ...
      expect(tag.toJson(), {
        ...
        'children': [
          ...
          {'start': 11, 'end': 12, 'text': ''}, // Generated by ignored text
        ],
      });
    });
...
[/list]
      ...
      expect(tag.toJson(), {
        ...
        'children': [
          ...
          {'start': 13, 'end': 14, 'text': ''}, // Generated by ignored text
        ],
      });
    });
  });
...
[*][color=#aabbcc]b[/color][/list]''';
    final tag = buildSingleTag(input: input);
    expect(tag.children.length, equals(5));
    expect(tag.children[0].name, equals('*'));
    expect(tag.children[1].isPlainText, equals(true));
    expect(tag.children[1].data, equals('a'));
    expect(tag.children[2].isPlainText, equals(true)); // Generated by ignored text
    expect(tag.children[2].data, equals(''));
    expect(tag.children[3].name, equals('*'));
    expect(tag.children[4].name, equals('color'));
    expect(tag.children[4].attribute, equals('#aabbcc'));
    expect(tag.children[4].children.length, equals(1));
    expect(tag.children[4].children[0].isPlainText, equals(true));
    expect(tag.children[4].children[0].data, equals('b'));
  });
